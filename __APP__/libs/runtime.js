...
!(function (e) {
    ...
    return function (i, a) {
      ...
      for (r.method = i, r.arg = a; ; ) {
        ...
        if ("next" === r.method) r.sent = r._sent = r.arg;
          ...
          if (o === _) throw ((o = k), r.arg);
          r.dispatchException(r.arg);
        } else "return" === r.method && r.abrupt("return", r.arg);
        o = S;
        var f = n(t, e, r);
        if ("normal" === f.type) {
          if (((o = r.done ? k : O), f.arg === G)) continue;
    ...
    if (t) {
      ...
      if (!isNaN(t.length)) {
        var r = -1,
          n = function e() {
            for (; ++r < t.length; )
              if (g.call(t, r)) return (e.value = t[r]), (e.done = !1), e;
  ...
  var v,
    ...
    L = w.asyncIterator || "@@asyncIterator",
    x = w.toStringTag || "@@toStringTag",
    E = "object" === ("undefined" == typeof module ? "undefined" : t(module)),
    j = e.regeneratorRuntime;
  if (j) E && (module.exports = j);
  else {
    (j = e.regeneratorRuntime = E ? module.exports : {}).wrap = r;
    ...
    (i.prototype = T.constructor = a),
      ...
      (j.async = function (t, e, n, o) {
        ...
        return j.isGeneratorFunction(e)
          ? i
      ...
      (p.prototype = {
        ...
        finish: function (t) {
          for (var e = this.tryEntries.length - 1; e >= 0; --e) {
            ...
            if (r.finallyLoc === t)
              return this.complete(r.completion, r.afterLoc), h(r), G;
          }
        },
        catch: function (t) {
          for (var e = this.tryEntries.length - 1; e >= 0; --e) {
